...
function createHomePage(req,res){
	...
	res.write("<legend><center><h1>Mongo DB Example on kubernetes v1.0.1</h1></center></legend>");
    res.write("<input type='button' onclick=\"location.href='/AddPayments'\" value='AddPayments' />");
